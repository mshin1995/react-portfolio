		    	...
		    	<div className="modal-dialog modal-dialog-centered modal-lg" role="document">
		    	  	<div className="modal-content">
		    			...
		    			<div className="modal-footer">
		    				<a className="btn btn-primary btn-link-1" href="https://github.com/mshin1995/game-up-frontend" target="_blank"><i className="fab fa-github"></i> Github</a>
		    			</div>
		    	  	</div>
		    	</div>
		    </div>
		    ...
		    <div className="modal fade" id="dinoModal" tabindex="-1" role="dialog" aria-labelledby="dinoModalLabel" aria-hidden="true">
		    	<div className="modal-dialog modal-dialog-centered modal-lg" role="document">
		    	  	<div className="modal-content">
		    			...
		    			<div className="modal-footer">
		    				<a className="btn btn-primary btn-link-1" href="https://github.com/mshin1995/DinoDash" target="_blank"><i className="fab fa-github"></i> Github</a>
		    			</div>
		    	  	</div>
		    	</div>
		    </div>
		    ...
		    <div className="modal fade" id="petModal" tabindex="-1" role="dialog" aria-labelledby="petModalLabel" aria-hidden="true">
		    	<div className="modal-dialog modal-dialog-centered modal-lg" role="document">
		    	  	<div className="modal-content">
		    			...
		    			<div className="modal-footer">
		    				<a className="btn btn-primary btn-link-1" href="https://github.com/mshin1995/Pet_Match_App" target="_blank"><i className="fab fa-github"></i> Github</a>
		    			</div>
		    	  	</div>
		    	</div>
		    </div>
		    ...
		    <div className="modal fade" id="nbaModal" tabindex="-1" role="dialog" aria-labelledby="nbaModalLabel" aria-hidden="true">
		    	<div className="modal-dialog modal-dialog-centered modal-lg" role="document">
		    	  	<div className="modal-content">
		    			...
		    			<div className="modal-footer">
		    				<a className="btn btn-primary btn-link-1" href="https://github.com/njenga-kariuki/NBA-Stat-Tracker-CLI-Program-FS-Mod-1-Project" target="_blank"><i className="fab fa-github"></i> Github</a>
		    			</div>
		    	  	</div>
		    	</div>
		    </div>
